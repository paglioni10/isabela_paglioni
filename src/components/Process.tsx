    ...
    <section id="processo" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            {/* Selo superior seguindo o padrão da Hero */}
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative aspect-[9/16] w-full max-w-[350px] rounded-[32px] overflow-hidden shadow-2xl border-[12px] border-white ring-1 ring-pink-100">
              <iframe 
                className="w-full h-full"
                src="https://www.youtube.com/embed/AqojyTG500g"
